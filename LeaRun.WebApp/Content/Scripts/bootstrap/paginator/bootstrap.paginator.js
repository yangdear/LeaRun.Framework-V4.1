...
(function ($) {
    ...
    BootstrapPaginator.prototype = {
        ...
        buildPageItem: function (type, page) {
            ...
            var itemContainer = $("<li></li>"),//creates the item container
                itemContent = $("<a href='javascript:void(0)'></a>"),//creates the item content
                text = "",
                title = "",
    ...
    $.fn.bootstrapPaginator.defaults = {
        ...
        itemTexts: function (type, page, current) {
            switch (type) {
            case "first":
            	return td_lang.global.first_page;
                //return "&lt;&lt;";
            case "prev":
            	return td_lang.global.page_up;
                //return "&lt;";
            case "next":
            	return td_lang.global.page_down;
                //return "&gt;";
            case "last":
            	return td_lang.global.last_page;
                //return "&gt;&gt;";
            case "page":
                return page;
            }
